...
import {SideNav, SideNavProfile} from "@/app/components/SideNav";
...
export const DashboardLayout = ({ children, path, onSearch }: any) => {
...
export const DashboardProfileLayout = ({ children, path, onSearch }: any) => {
    const router = useRouter();
    const pathName = usePathname();
