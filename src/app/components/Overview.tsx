    ...
    return (
        <>
            <div className="flex flex-wrap gap-4">
                {data.map((data: any) =>
                    <div className={classnames("flex justify-between h-48 w-[48%] rounded-md text-textColor", classname)} style={{ background: data.color, color: data.color === '#171714' ? "#ffffff" : "" }}>
    ...
    return (
        <>
            <div className="flex gap-4">
                {[...new Array(3).fill(0)].map((data: any) =>
                    <div className="w-1/3 rounded-md bg-slate-200 h-40 animate-pulse" style={{ backgroundColor: data.color }}>
                        <div>
